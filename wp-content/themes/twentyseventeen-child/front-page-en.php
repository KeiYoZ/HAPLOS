...
<div class="container-fluid">
	<!-- First section start -->
	<div class="section" style="background-color: #619880; padding-top:70px;">
	...
	<div class="section" id="ano_ang_haplos" style="background-color: #e5e3da;">
	...
	<!-- Fifth section start -->
	<div class="section section-5-container" id="mga_ospital" style="background-color: #619880; padding-top:6%;">
		<div class="row">
